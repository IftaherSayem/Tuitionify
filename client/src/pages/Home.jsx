  ...
  return (
    <div>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 md:grid-cols-2 md:py-24">
          <div>
            ...
            <h1 className="mt-4 text-4xl font-extrabold leading-tight tracking-tight text-slate-900 sm:text-5xl">
              Find the right <span className="text-brand-600">tutor</span>, or your next{' '}
              <span className="text-brand-600">tuition</span>.
            </h1>
          ...
          <div className="relative">
            <div className="card space-y-4 p-6 shadow-lg">
              <div className="flex items-center gap-3">
                <img src="https://i.pravatar.cc/150?img=12" alt="" className="h-12 w-12 rounded-full ring-2 ring-brand-100" />
                <div>
                  <p className="font-semibold text-slate-900">Tanvir Ahmed</p>
              ...
              <div className="flex items-center justify-between text-sm text-slate-600">
                <span className="flex items-center gap-1"><MapPin size={15} className="text-slate-400" /> Mirpur, Dhaka</span>
                <span className="font-semibold text-brand-700">৳6,000/mo</span>
              </div>
              <button className="btn-primary w-full">View Profile</button>
            </div>
            <div className="absolute -bottom-5 -left-5 hidden rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-md sm:block">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-slate-900">How Tuitionify works</h2>
          <p className="mt-2 text-slate-500">Three simple steps for both tutors and guardians.</p>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex items-end justify-between">
            <div>
              <h2 className="text-3xl font-bold text-slate-900">Popular subjects</h2>
              <p className="mt-2 text-slate-500">From primary school to admission coaching.</p>
            </div>
            <Link to="/tutors" className="hidden items-center gap-1 text-sm font-semibold text-brand-700 hover:gap-2 sm:flex">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {SUBJECTS.map((s) => (
              <Link
                ...
                className="flex items-center gap-2 rounded-full border border-slate-200 bg-slate-50 px-4 py-2 text-sm font-medium text-slate-700 transition hover:border-brand-300 hover:bg-brand-50 hover:text-brand-700"
              >
                <BookOpen size={15} /> {s}
              </Link>
            ))}
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6">
        <div className="grid gap-6 md:grid-cols-2">
          <div className="card flex flex-col justify-between bg-gradient-to-br from-brand-600 to-brand-700 p-8 text-white">
            <div>
              <Users size={32} />
          ...
          <div className="card flex flex-col justify-between p-8">
            <div>
              ...
              <h3 className="mt-4 text-2xl font-bold text-slate-900">For Tutors</h3>
